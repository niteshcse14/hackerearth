...
void solve()
{
	...
	int flag = 1;
	if(abs(arr[0] - arr[2]) != abs(arr[3] - arr[5]))
	{
		flag = 0;
	}
	if(abs(arr[6] - arr[4]) != abs(arr[3] - arr[5]))
	{
		flag = 0;
	}
	if(abs(arr[7] - arr[1]) != abs(arr[6] - arr[4]))
	{
		flag = 0;
	}
	if(abs(arr[7] - arr[1]) != abs(arr[2] - arr[0]))
	{
		flag = 0;
	}
	if(abs(arr[7] - arr[1]) != abs(arr[3] - arr[5]))
	{
		flag = 0;
	}
	if(abs(arr[6] - arr[4]) != abs(arr[2] - arr[0]))
	{
		flag = 0;
	}
	if(flag == 1)
